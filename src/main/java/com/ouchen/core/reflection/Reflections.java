 ...
 */
package com.ouchen.core.reflection;
...
public class Reflections {
	 ...
	 * @param params
	 */
	public static <T extends Object> void invokeMap2Pojo(Object t, Map<String, Object> params){
	...
	/**
	 * 从一个构造器对象加载一个类实例
	 * @param cons 		Constructor 一个类的构造器
	 * @param initargs Object[] 构造方法初始化参数的值
	 * @return Object
	 * @throws IllegalArgumentException
	 * @throws InvocationTargetException
	 * @throws InstantiationException
	 ...
	 * @param parameterTypes 	Class[] 构造方法的参数类型
	 * @return Constructor
	 * @throws ClassNotFoundException 构造方法的参数值
	 * @throws NoSuchMethodException
	 * @throws SecurityException
	 * @preserve 声明此方法不被JOC混淆
	 */
