                    ...
                    if ($("#bussinessId").val()) {
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data && data.resultCode === '0') {
                                    su = data.resultData;
                                    $("#bussinessName").val(su.bussinessName);
                                    $("#bussinessEmail").val(su.bussinessEmail);
                                    $("#bussinessTel").val(su.bussinessTel);
                                    $("#bussinessDesc").val(su.bussinessDesc);
